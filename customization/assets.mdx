...
<Card title="Upload Avatar/Background" icon="circle-1" href="../customization/assets#how-to-upload-avatar-background" horizontal>
Learn how to upload your avatar and background to your profile.
</Card>

<Card title="Upload Audios" icon="circle-2" href="../customization/assets#how-to-upload-audios" horizontal>
Learn how to upload audios to your profile.
</Card>

<Card title="Upload Cursors" icon="circle-3" href="../customization/assets#how-to-upload-cursors" horizontal>
