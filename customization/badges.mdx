...
<Frame caption="The winner badge is given to users who have won an event held by haunt.">
  ![Invitor Badge](../images/winner-badge.png)
</Frame>

### Second Place Badge

<Frame caption="The second place badge is given to anyone who came second place in an event held by haunt.">
  ![Invitor Badge](../images/second-place-badge.png)
</Frame>
...
<Note>
  You can see when we host an event in our
  [Discord server](https://discord.gg/ACRnRJs496) to earn any of these three badges.
</Note>
