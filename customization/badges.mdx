...
<Steps>
  ...
  <Step title="Explore the Options">
    The following features are available: - **Badge Color**: Select a base color
    using the color picker or hex input. - **Monochrome Badges**: Apply a
    singular badge color selected to the left for a cleaner look. - **Glow
    Badges**: Enable glowing outlines around your badges for extra emphasis. -
