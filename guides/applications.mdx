...
<Card title="Access Applications" icon="circle-1" href="../guides/applications#how-do-i-access-my-applications%3F" horizontal>
Learn how to access your applications.
</Card>

<Card title="Overview" icon="circle-2" href="../guides/applications#overview" horizontal>
Check out which information you can see on the application overview page.
</Card>

<Card title="Form Preview" icon="circle-3" href="../guides/applications#form-preview" horizontal>
Learn how to preview a form.
</Card>

<Card title="Review Note" icon="circle-4" href="../guides/applications#review-note" horizontal>
Learn more about a review note given to your application.
</Card>
</div>
