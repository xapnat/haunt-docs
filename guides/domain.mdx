...
<Card title="Available Domains" icon="circle-1" href="../guides/domain#what-domains-are-available-right-now" horizontal>
Check out all available domains.
</Card>

<Card title="Link the Domain(s) to your Discord Account" icon="circle-2" href="../guides/discord#domain#how-can-i-link-the-domain-to-my-discord" horizontal>
Learn how to enable your discord presence on your profile.
</Card>

<Card title="Donate Domain" icon="circle-3" href="../guides/domain#how-can-i-donate-my-domain-to-the-haunt-gg-team" horizontal>
