...
- These are the Domains that are available and ready to use: [haunt.gg](https://haunt.gg/), [exitscam.xyz](https://exitscam.xyz/), [fentanyl.ing](https://fentanyl.ing), [rich.bz](https://rich.bz/)
...
<Steps>
    ...
    <Step title="Head to the Haunt.gg Discord">
        Head to the Haunt.gg Discord and then click on CMD and Enter the Command: /connect domain [Domain] [Record_Value] | The Record_Value is the Content that you Copied!
        <Frame>
...
## How can i provide my Domain to the Haunt.gg Team?

<Note>
    Open a Ticket in the Haunt.gg [Discord Server](discord.gg/hauntgg) for more information about how to provide your Domain to the Haunt.gg Team.
</Note>