...
<Card title="View Uploaded Images" icon="circle-8" href="../guides/imagehost#view-uploaded-images" horizontal>
Learn how to access your uploaded images.
</Card>

<Card title="Limits" icon="circle-9" href="../guides/imagehost#limits" horizontal>
...
<Info>
The Image Host subscription with the most storage and largest file size limit can be purchased [here](https://haunt.gg/pricing). If you purchase this product, you will also receive the [Image Host badge](https://help.haunt.gg/customization/badges#image-host).
</Info>
