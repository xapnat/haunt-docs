...
<Info>
To view the list of available domain options, click [here](https://help.haunt.gg/guides/imagehost#supported-domains).
</Info>
...
<Info>
At this time, only **i.haunt.gg** is supported. More domains will be available soon.
</Info>

<Tip>
We appreciate every domain suggestion or donation.  
If you’d like to suggest a domain, [join our Discord server](https://discord.gg/hauntbio).  
To donate a domain, please open a ticket in the server.
</Tip>
...
<Tabs>
  ...
  <Tab title="Upload Client">
    To download the configuration file for your upload client, follow the instructions [here](https://help.haunt.gg/guides/imagehost#upload-client).
  </Tab>
</Tabs>
