...
<Card title="Multiaccounting Policy" icon="circle-1" href="../guides/imagehost#how-do-i-access-the-image-host%3F" horizontal>
Learn more about the multiaccounting policy.
</Card>

<Card title="Creating multiple accounts" icon="circle-2" href="../guides/imagehost#general-customization" horizontal>
Learn how to create multiple accounts on haunt.gg.
</Card>

<Card title="Unban previously banned accounts" icon="circle-3" href="../guides/imagehost#domains" horizontal>
