...
<div className="tab-scroll-wrapper">
  <div className="tab-scroll-button" onclick="this.nextElementSibling.scrollBy({left:-100, behavior:'smooth'})">◀</div>
...
<Tabs>
  ...
  <div className="tab-scroll-button" onclick="this.previousElementSibling.scrollBy({left:100, behavior:'smooth'})">▶</div>
</div>
