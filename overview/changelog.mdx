...
<Update label="June, 2025">
    **Utilities & Core Features**  
    ...
    - Added **customization** for badges background card
    - Added **customization** for discord presence cards
    
    **UI/UX Improvements**
    - Added **customization** for the link icon size
    - Added **customization** for the open graph image
    - Improved sidebar for smaller devices
    ...
    **Visual & Decorative Updates**  
    ...
    - Added **more decorations** for discord presence card
</Update>
